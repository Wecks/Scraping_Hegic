...
url_btc_7 = "https://www.hegic.co/app#/arbitrum/trade/new?position=0&sentiment=high&strategyName=high-straddle&strikeName=straddle&period=7&asset=BTC"
...
sheet["R"+index].value = "BTC/USD"
sheet["S"+index].value = 7
sheet["T"+index].value = data['price']
sheet["U"+index].value = premium.replace(" ","")
